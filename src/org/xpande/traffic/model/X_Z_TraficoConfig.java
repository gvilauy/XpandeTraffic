...
/** Generated Model for Z_TraficoConfig
 *  @author Adempiere (generated) 
 *  @version Release 3.9.0 - $Id$ */
public class X_Z_TraficoConfig extends PO implements I_Z_TraficoConfig, I_Persistent 
{
    ...
    public X_Z_TraficoConfig (Properties ctx, int Z_TraficoConfig_ID, String trxName)
    {
      super (ctx, Z_TraficoConfig_ID, trxName);
      /** if (Z_TraficoConfig_ID == 0)
        {
			setC_Country_ID (0);
			setValue (null);
    ...
    /** Load Constructor */
    public X_Z_TraficoConfig (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_TraficoConfig[")
	...
	public void setZ_TraficoConfig_ID (int Z_TraficoConfig_ID)
	{
		if (Z_TraficoConfig_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_TraficoConfig_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_TraficoConfig_ID, Integer.valueOf(Z_TraficoConfig_ID));
	}
